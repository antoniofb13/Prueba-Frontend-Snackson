  ...
  <q-page padding>
    ...
    <section class=" q-gutter-xl ">
      ...
      -->
        ...
        <p class="text-h6" id="txtTit"><b>{{ item.title}}</b></p>
        <!-- Descripción corta del juego -->
        <p class="desc">{{ item.short_description}}</p>
        <!-- Información adicional del juego -->
        
        <span class="badge text-bg-secondary" id="etiq">{{ item.genre}}</span>
        <span class="badge text-bg-secondary" id="etiq2">{{ item.platform}}</span>
